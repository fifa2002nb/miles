...
$BASEConfig = array(
    ...
    'DB_HOST'            =>    '115.231.98.85',    // 数据库服务器地址
    'DB_NAME'            =>    'test',            // 数据库名
    'DB_USER'            =>    'uaq',        // 数据库用户名
    'DB_PWD'             =>    '2012uaq',    // 数据库密码
    'DB_PORT'            =>    '3306',            // 数据库端口
    ...
    'AUTH_CONFIG'=>array(
        ...
        'AUTH_GROUP' => 'test_auth_group', //用户组数据表名
        'AUTH_GROUP_ACCESS' => 'test_auth_group_access', //用户组明细表
        'AUTH_RULE' => 'test_auth_rule', //权限规则表
        'AUTH_USER' => 'test_user',//用户信息表
        /**
         * 无需登录模块
         */

...
$tmp = explode("/", $_GET["s"]);
//file_put_contents("/home/uaq/opbin/xuye/php.log", $_GET["s"]." ".count($tmp)."\n", FILE_APPEND);
switch(count($tmp)) {
    case 0:
    case 1:
    case 2:
    case 3:
        ...
        //file_put_contents("/home/uaq/opbin/xuye/php.log", $_GET["s"]."|$group|$app|$module|$ext\n", FILE_APPEND);
        // /overview/overview.json|overview|overview.json|overview|json
        break;
    case 4:
...
//file_put_contents("/home/uaq/opbin/xuye/php.log", $_GET["s"]." ".json_encode($urlRoutes)."\n", FILE_APPEND);
